...
def get_car_serial_no(filters):
	...
	# 
	price_list_type = frappe.db.get_single_value('Selling Settings', 'selling_price_list')
	filters.update({"price_list_type": price_list_type})	
...
inner join `tabItem Price` as TP
on TI.item_code=TP.item_code
